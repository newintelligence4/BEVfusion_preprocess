...
#include "velocity_msg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Num_type_support_symbol_names_t _Num_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, velocity_msg, msg, Num)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, velocity_msg, msg, Num)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_velocity_msg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, velocity_msg, msg, Num)() {
  return &::velocity_msg::msg::rosidl_typesupport_c::Num_message_type_support_handle;
}
