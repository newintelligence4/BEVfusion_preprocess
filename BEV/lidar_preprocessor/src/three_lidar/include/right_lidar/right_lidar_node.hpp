#ifndef RIGHT_LIDAR__RIGHT_LIDAR_NODE_HPP_
#define RIGHT_LIDAR__RIGHT_LIDAR_NODE_HPP_
...
class RIGHT_PREPROCESSING : public rclcpp::Node
{
  public:
    explicit RIGHT_PREPROCESSING(const rclcpp::NodeOptions &options = rclcpp::NodeOptions());
    ~RIGHT_PREPROCESSING() {};
...
#endif //RIGHT_LIDAR__RIGHT_LIDAR_NODE_HPP_