...
def generate_test_description():
    ...
    rviz2_config =  os.path.join(ament_index_python.get_package_prefix('lidar_preprocessing'),
            'lib/lidar_preprocessing/',
            'lidar_preprocessing.rviz')
    #rviz2_config = os.path.join(ament_index_python.get_package_share_directory('lidar_preprocessing'),'lidar_preprocessing', 'lidar_preprocessing_rviz2.rviz')
...
class TestProcessOutput(unittest.TestCase):
    ...
    def timer_callback(self):
        ...
        input_data_path = os.path.join(
            ament_index_python.get_package_prefix('lidar_preprocessing'),
            'lib/lidar_preprocessing/',
